<template>
  <div class="navbar">
    ...
    <div class="route-container">
      <div class="nav-item" @click="scroll('hero')">
        <p class="button" >Home</p>
      </div>
      <div class="nav-item" @click="scroll('about')">
        <p class="button">About</p>
      </div>
      <div class="nav-item" @click="scroll('portfolio')">
        <p class="button">Portfolio</p>
      </div>
      <div class="nav-item" @click="scroll('contact')">
